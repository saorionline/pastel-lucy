...
import BreadcrumbOne from "../elements/BreadcrumbOne";
        ...
        <>
            ...
            <Layout>
                ...
                <main className="main-content">
                    {/* Start Elements Area  */}
                    <section className="rwt-gallery-area rn-section-gap">
                    ...
                    {/* Start Elements Area  */}
                    <section className="rwt-gallery-area rn-section-gapBottom">
                        <details className="container">
                            <div className="row">
                                <div className="col-lg-12 mb--20">
                                    <SectionTitle
